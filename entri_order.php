...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Menu</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
    ...
    <li class="active"> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Menu</span></a> </li>
                        ...
                        <table class="table table-bordered">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="deskripsi"><?php echo $r_dt_makanan['deskripsi'];?></td>
