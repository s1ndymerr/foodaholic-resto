...
?>
    ...
    <body>
      ...
      <div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> Beranda</a>
        <ul>
          ...
          ?>
            ...
            <li> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Menu</span></a> </li>
          ...
          ?>
            <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Entri Referensi</span></a> </li>
            <li> <a href="lihat_pesanan.php"><i class="icon icon-tag"></i> <span>Lihat Pesanan</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li>
            <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
          <?php
                      ...
                      <div class="widget-box">
                        <div class="widget-content nopadding">
                          <ul class="site-stats quick-actions">
                            ...
                            <li class="bg_ly"><i class="icon-user"></i> <strong><?php echo $result_wtr['jumlah_wtr']; ?></strong> <small>Total Chef Manager</small></li>
            ...
            ?>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="item active">
                          <img src="template/masuk/images/poster1.png" alt="First Slide">
                        </div>
                        <div class="item">
                          <img src="template/masuk/images/poster2.png" alt="Second Slide">
                        </div>
                        <div class="item">
                          <img src="template/masuk/images/poster3.png" alt="Third Slide">
                        </div>
                      </div>
                      <!-- Carousel controls -->
              ...
              <div class="alert alert-orange alert-block">
                <center>
                  ...
                  <h5>Di Pelayanan Restoran FOODAHOLIC</h5>
                </center>
              </div>
            <?php
            }
      ...
      <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restaurant <a href="#">by kelompok8</a> </div>
      </div>
