...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-tag"></i> <span>Lihat Pesanan</span></a>
  <ul>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> 
      <a href="lihat_pesanan.php" title="Lihat Pesanan" class="tip-bottom"><i class="icon icon-tag"></i>
        Lihat Pesanan
      </a>
      <a href="lihat_detail.php" title="Detail" class="tip-bottom"><i class="icon icon-ok"></i> 
        Detail
      </a>
    </div>
  </div>
